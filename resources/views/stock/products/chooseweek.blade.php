			...
			<table id="table" class="table table-striped table-bordered table-hover" style="width: 100%">
				...
				<tbody>
					...
					<tr class="pointer" onclick="window.location.assign('{{ url('stock/produits/semaines/' . $week->id) }}')">
						...
						<td class="responsive-td" data-responsive-field="Nom">{{ $week->name }} <i id="edit" title="choisir" class="fa fa-play fa-2x" style="color:#007bff;cursor:pointer;float:right;margin-right:10px;"></i></td>
					</tr>
					@endforeach
